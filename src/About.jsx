      ...
      <div className="p-[5rem] pt-32 bg-[#1e293bd7]">
        ...
        <div className="w-[80%] mx-auto text-[1.2rem] font-light flex flex-col gap-8">
          <p>
            ...
            relentless quest for learning and improvement, constantly honing my
            skills in Problem Solving, Web Development and Machine Learning.
          </p>
          <p>
            What sets me apart is my commitment to not just writing code, but
            crafting solutions that solve real-world problems and deliver
            tangible results. I thrive in collaborative environments where I can
            brainstorm ideas, iterate on designs, and ultimately build products
            that make a difference. I approach every project with enthusiasm and
          ...
          <p>
            ...
            work-life balance to fuel creativity and productivity.
          </p>
          <p>
